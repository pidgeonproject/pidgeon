...
namespace Pidgeon
{
    ...
    public class IProtocolMeta
    {
        ...
        public virtual void Transfer(string data, libirc.Defs.Priority priority = libirc.Defs.Priority.Normal, Network network = null)
        {
    ...
    /// </summary>
    [Serializable]
    public class ProtocolMeta : IProtocolMeta
    {
        /// <summary>
        ...
        /// <param name="priority"></param>
        /// <returns></returns>
        public virtual int Message2(string text, string to, libirc.Defs.Priority priority = libirc.Defs.Priority.Normal)
        {
        ...
        /// <returns></returns>
        public virtual int Message(string text, string to, libirc.Defs.Priority priority = libirc.Defs.Priority.Normal, bool pmsg = false)
        {
        ...
        /// <returns></returns>
        public virtual int Message(string text, string to, Network network, libirc.Defs.Priority priority = libirc.Defs.Priority.Normal, bool pmsg = false)
        {
