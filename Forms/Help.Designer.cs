    ...
    public partial class Help
    {
        ...
        private void Build()
        {
            ...
            this.textview1.Buffer.Text = 
                "About:\n\nThe pidgeon project was established as an open source which anyone can edit" +
                " or improve, or even suggest new features to. The source code is located at github" +
                " (link is available on wiki), but in order to submit patches, you don't need to be" +
                " a member of the project.\n\nThat means:\nEveryone who wants to contribute to this" +
                " project, is welcome and definitely should be able to do that, there is no need to" +
                " request any permissions to modify the core sources or to develop plugins. If you like" +
                " this project and you want to contribute to make pidgeon even better, please see our" +
                " website\n\nLicense:\n\nThis program is free software; you can redistribute it and/or" + 
                " modify it under the terms of the GNU General Public License as published by the Free" +
                " Software Foundation; either version 2 of the License, or  (at your option) version " +
